...
import models.networks as cycle
from misc import *
...
parser.add_argument('--exp', default='sample_dhaze_single_ori_withfree', help='folder to output images and model checkpoints')
...
#        errG = errGan_A+errc_A + 0.1*errLp_A
        errG = errGan_A + 0.01*errLp_A+errc_A
...
#            break
        ...
        if epoch % 2 == 0:            
            torch.save(netG.state_dict(), '%s/netG_singleoriepoch_%d.pth' % (opt.exp, epoch))
