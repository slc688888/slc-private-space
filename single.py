...
parser.add_argument('--exp', default='sample4', help='folder to output images and model checkpoints')
...
#            break
        ...
        if epoch % 2 == 0:            
            torch.save(netG.state_dict(), '%s/netG_singleepoch_%d.pth' % (opt.exp, epoch))
