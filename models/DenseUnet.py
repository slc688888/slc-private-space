...
#        down_layer.add_module('convdown', nn.Conv2d(num_init_features*2, num_init_features, kernel_size=3, stride=2, padding=1, bias=False))
#        down_layer.add_module('normdown', nn.InstanceNorm2d(num_init_features,affine=True))
#        down_layer.add_module('reludown', nn.ReLU(inplace=True))
#        self.down_layer=down_layer
#
#        down_layer2 = nn.Sequential()
#        down_layer2.add_module('convdown2', nn.Conv2d(num_init_features, num_init_features, kernel_size=3, stride=2, padding=1, bias=False))
#        down_layer2.add_module('normdown2', nn.InstanceNorm2d(num_init_features,affine=True))
#        down_layer2.add_module('reludown2', nn.ReLU(inplace=True))
#        self.down_layer2=down_layer2
...
#        
#        self.HDC3 = HDC(num_init_features*2)
...
#        final_layer.add_module('conv', nn.Conv2d(num_init_features*2, num_init_features, kernel_size=3, stride=1, padding=1))
#        final_layer.add_module('norm', nn.InstanceNorm2d(num_init_features,affine=True))
...
#        final_net.add_module('relufinal', nn.ReLU(inplace=True))
...
#        self.HDC11 = HDC(num_init_features)
#        
#        self.HDC2 = HDC(num_init_features*2,6)
#        self.HDC22 = HDC(num_init_features,6)
#
#        self.HDC31 = HDC(num_init_features*4,6)
#        self.HDC32 = HDC(num_init_features,6)        
#        up_layer = nn.Sequential()
#        up_layer.add_module('convup', nn.ConvTranspose2d(num_init_features*3, num_init_features, kernel_size=4, stride=2, padding=1))
#        up_layer.add_module('normup', nn.InstanceNorm2d(num_init_features,affine=True))
#        up_layer.add_module('reluup', nn.ReLU(inplace=True))
#        self.up_layer=up_layer      
#        
#        self.HDC3 = HDC(num_init_features*6)
#        self.HDC33 = HDC(num_init_features)
#                
#        last_layer = nn.Sequential()
#        last_layer.add_module('convlast', nn.ConvTranspose2d(num_init_features*8, num_init_features, kernel_size=4, stride=2, padding=1))
#        last_layer.add_module('normlast', nn.InstanceNorm2d(num_init_features,affine=True))
#        last_layer.add_module('relulast', nn.ReLU(inplace=True))
#        self.last_layer=last_layer
#
...
#        self.final_net=final_net        
        ...
        self.final_net=final_net  
    def forward(self, x):
#        y0=self.init_layer(x)
#        y0=self.first_layer(y0)
#        y1=self.second_layer(y0)
#        y11=self.down_layer2(y1)
#        
#        HDC1=self.HDC1(y1)
#        HDC1=self.HDC11(HDC1)
#        y2=self.down_layer(torch.cat((HDC1, y1), dim=1))
#        y2=torch.cat((y2, y11),dim=1)
#        
#        HDC2=self.HDC2(y2)
#        HDC2=self.HDC22(HDC2)
#        y3=torch.cat((HDC2, y2), dim=1)
#        y3=self.up_layer(y3)
#        y33=torch.cat((y3, y1), dim=1)  
#        
#        HDC3=self.HDC3(y3)
#        HDC3=self.HDC33(HDC3)
#        y4=torch.cat((HDC3,y1,y3), dim=1)        
#        
#        y4=self.last_layer(y4)
#        y5=torch.cat((y4, y0), dim=1)
#        y5=self.final_layer(y5)
#        y5=torch.cat((y5, x), dim=1)
#        output=self.final_net(y5)
#        """remove last two residual,maxpooling"""       
#        y0=self.init_layer(x)
#        y0=self.first_layer(y0)
#        y1=self.second_layer(y0)
#        
#        HDC1=self.HDC1(y1)
#        HDC1=self.HDC11(HDC1)
##        y2=F.max_pool2d(torch.cat((HDC1, y1), dim=1))
#        y2=torch.cat((HDC1, y1),dim=1)
#        
#        HDC2=self.HDC2(y2)
#        HDC2=self.HDC22(HDC2)
#        y3=torch.cat((HDC2, y2), dim=1)
##        y3=self.up_layer(y3)
##        y3=torch.cat((y3, y1), dim=1)  
#        
#        HDC3=self.HDC3(y3)
#        HDC3=self.HDC33(HDC3)
...
##        y5=torch.cat((y5, x), dim=1)
#        output=self.final_net(y5)
        """all connected ,maxpooling"""       
#        y0=self.init_layer(x)
#        y0=self.first_layer(y0)
##        y1=self.second_layer(y0)
#        y1=F.max_pool2d(y0,kernel_size=2, stride=2,padding=0)
#        y11= F.max_pool2d(y1,kernel_size=2, stride=2,padding=0)
#        
#        HDC1=self.HDC1(y1)
#        HDC1=self.HDC11(HDC1)
...
#        HDC2=self.HDC2(y2)
#        HDC2=self.HDC22(HDC2)
#        y3=torch.cat((HDC2, y2,y1), dim=1)
##        y3=torch.cat((y3, y1), dim=1)  
#        HDC31=self.HDC31(y3)
#        HDC32=self.HDC32(HDC31)
#        y3=torch.cat((HDC32, y3,y1), dim=1)
#        
#        HDC3=self.HDC3(y3)
#        HDC3=self.HDC33(HDC3)
#        y4=torch.cat((HDC3,y3,y1), dim=1)        
#        
#        y4=self.last_layer(y4)
#        y5=torch.cat((y4, y0), dim=1)
#        y5=self.final_layer(y5)
